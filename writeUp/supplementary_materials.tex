...
\begin{tabular}{l|l|l|l|l|l|l|l|l}
	...
	\hline
	\textit{Anopheles} & \textit{funestus} & 5.7 & 9.5 & 13.8 & 21.7 & 51.2 & 22.0 & 82.5 \\
	\textit{Anopheles} & \textit{funestus s.l.} & 5.1 & 9.0 & 15.2 & 29.5 & \text{$>$100} & 36.6
	& \text{$>$100} \\
	\textit{Anopheles} & \textit{nili s.l.} & 6.6 & 10.4 & 14.4 & 20.6 & 42.4 & 19.8 & 40.4 \\
	\textit{Anopheles} & \textit{gambiae} & 4.7 & 7.0 & 9.8 & 14.0 & 26.6 & 12.1 & 9.0 \\
	\textit{Anopheles} & \textit{gambiae (Form M)} & 3.3 & 6.0 & 9.5 & 16.2 & 49.0 &
	\text{$>$100} & \text{$>$100} \\
	\textit{Anopheles} & \textit{arabiensis} & 3.7 & 5.7 & 8.2 & 13.0 & 27.7 & 11.4 & 12.4 \\
	\textit{Anopheles} & \textit{gambiae s.l.} & 4.0 & 6.6 & 10.1 & 16.8 & 41.9 & 15.3 & 19.2 \\
	\textit{Anopheles} & \textit{leucosphyrus} & 5.8 & 9.5 & 13.2 & 18.4 & 37.4 & 32.8 &
	\text{$>$100} \\
	\textit{Anopheles} & \textit{leucosphyrus s.l.} & 5.2 & 9.0 & 12.9 & 18.2 & 38.0 & 21.8 &
	\text{$>$100} \\
	\textit{Anopheles} & \textit{aconitus} & 2.6 & 6.0 & 10.8 & 20.6 & \text{$>$100} &
	\text{$>$100} & \text{$>$100} \\
	\textit{Anopheles} & \textit{dirus (Sp. A)} & 5.8 & 8.7 & 12.1 & 17.5 & 33.5 & 15.1
	& 11.7 \\
	\textit{Anopheles} & \textit{dirus s.l.} & 4.9 & 7.5 & 10.8 & 16.0 & 34.6 & 14.3 & 14.1 \\
	\textit{Anopheles} & \textit{barbirostris s.l.} & 2.7 & 6.1 & 9.9 & 19.1 & \text{$>$100} &
	\text{$>$100} & \text{$>$100} \\
	\textit{Anopheles} & \textit{minimus (Sp. A)} & 3.5 & 7.3 & 11.8 & 21.0 & 91.4 &
	96.9 & \text{$>$100} \\
	\textit{Anopheles} & \textit{minimus s.l.} & 4.5 & 6.7 & 9.2 & 13.0 & 24.0 & 11.3 & 11.9 \\
	\textit{Anopheles} & \textit{maculatus} & 3.6 & 5.7 & 8.2 & 12.6 & 26.6 & 11.8 & 42.5 \\
	\textit{Anopheles} & \textit{maculatus s.l.} & 3.7 & 6.0 & 8.7 & 13.4 & 29.1 & 12.5 & 19.6
	\\
	\textit{Anopheles} & \textit{subpictus s.l.} & 2.4 & 4.8 & 8.4 & 18.0 & 87.1 & \text{$>$100}
	& \text{$>$100} \\
	\textit{Anopheles} & \textit{sundaicus s.l.} & 2.7 & 5.1 & 8.3 & 14.9 & 63.4 & \text{$>$100}
	& \text{$>$100} \\
	\textit{Anopheles} & \textit{anthropophagus (lesteri)} & 3.4 & 5.3 & 7.4 & 11.1 & 24.8 &
	10.7 & 18.1 \\
	\textit{Anopheles} & \textit{annularis s.l.} & 5.0 & 6.3 & 7.4 & 8.6 & 11.6 & 7.8 & 2.4 \\
	\textit{Anopheles} & \textit{culicifacies s.l.} & 2.9 & 4.7 & 7.1 & 11.4 & 25.3 & 10.5 &
	26.1 \\
	\textit{Anopheles} & \textit{sinensis} & 3.9 & 5.4 & 7.0 & 9.5 & 15.1 & 8.0 & 4.0 \\
	\textit{Anopheles} & \textit{fluviatilis s.l.} & 4.2 & 5.6 & 6.9 & 8.6 & 12.5 & 7.4 & 2.8 \\
	\textit{Anopheles} & \textit{farauti (No.1)} & 4.1 & 5.4 & 6.4 & 7.7 & 11.1 & 8.9 &
	96.2 \\
	\textit{Anopheles} & \textit{farauti s.l.} & 4.5 & 5.7 & 6.6 & 7.7 & 10.1 & 6.8 & 1.8 \\
	\textit{Anopheles} & \textit{darlingi} & 3.0 & 5.3 & 8.7 & 16.0 & 52.6 & \text{$>$100} &
	\text{$>$100} \\
	\textit{Anopheles} & \textit{aquasalis} & 3.3 & 5.1 & 7.6 & 12.0 & 28.5 & 11.3 & 19.4 \\
	\textit{Anopheles} & \textit{pseudopunctipennis s.l.} & 4.2 & 6.1 & 7.5 & 9.6 & 17.7 & 40.5
	& \text{$>$100} \\
	\textit{Anopheles} & \textit{albitarsis (Sp C)} & 3.4 & 8.2 & 18.2 & 55.8
	& \text{$>$100} & \text{$>$100} & \text{$>$100} \\
	\textit{Anopheles} & \textit{albitarsis (Sp A)} & 2.4 & 3.6 & 5.0 & 7.4 & 17.6 &
	8.2 & 32.0 \\
	\textit{Anopheles} & \textit{albitarsis (Sp. B)} & 2.6 & 3.6 & 4.7 & 6.5 & 11.9 & 5.7 & 4.4
	\\
	\textit{Anopheles} & \textit{albitarsis s.l.} & 2.3 & 4.1 & 6.9 & 13.5 & 56.3 & 24.0 &
	\text{$>$100} \\
	\textit{Anopheles} & \textit{albimanus} & 3.0 & 4.6 & 6.4 & 9.5 & 20.2 & 9.2 & 34.7 \\
	\textit{Anopheles} & \textit{nuneztovari s.l.} & 2.3 & 3.9 & 5.7 & 10.0 & 45.8 &  
	\text{$>$100} & \text{$>$100} \\
\end{tabular}
