...
the SOM using estimates of gonotrophic cycle duration (Fig. \ref{S-fig:dissection_gonotrophicCycleRaw}). Table S\ref{S-tab:dissection_estimated_lifespans_chron} provides posterior summaries of chronological for the species and genera in the dissection dataset. For ten species, we had enough data from both species to make a comparison, and there was a positive correlation (not
...
time-series level LBLs (Table S\ref{S-tab:comparison}).
...
species with a posterior median LBL of 12.4 days (mean estimate;
...
S\ref{S-tab:mrr_survivalDescription}) for case study populations with three different levels of
...
experiments included in our analysis was 10 days (Table S\ref{S-tab:mrr_IndividualData}) this could
